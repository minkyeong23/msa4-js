...
//    문자열에서 해당 인덱스의 맞는 문자를 반환 
let str4 = "문자열입니다.";
console.log(str4.charAt(6));

// String.indexOf(seachStr, idx): Number
...
// Stirng.replace(pattern, replacement): String
//    문자열에서 해당 패턴의 첫번쨰 문자열을 찾아서,
//    대체문자열로 변경한 문자열을 반환
let str6 = "문자열입니다. 문자열입니다.";
console.log(str6.replace('열', ''));
console.log(str6.replace('문자열', '돈가스').replace('문자열', '돈'));
...
//    문자열에서 시작 인덱스부터 끝 인덱스까지 다른 문자열을 반환
//    끝 인덱스 생략 시, 시작 인덱스부터 끝까지 다른 문자열을 반환
