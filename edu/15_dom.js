...
// Element.setAttribute(attributenName, value)
//  요소에 속성과 속성 값을 추가
...
// document.creatElement(tagName): 해당 tag 요소 생성
const newP = document.createElement('p');
newP.textContent = '탕수육'; 
newP.style.color = '#9d00ff';

// Node.apppendChild(node)
...
// 해당 부모 요소의 자식 노드 중 타겟 앞에 새로운 노드 추가
